...
class Sections: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        tblText.delegate = self
        tblText.dataSource = self
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "SectionsTVC", for: indexPath) as! SectionsTVC
        
        cell.lblText!.text = items [indexPath.section][indexPath.row]
  return cell
    }
